...
const CoffeeCard = ({ coffee,coffees,setCoffees}) => {
  ...
  return (
    <div className="card card-side bg-base-100 w-80 h-50 shadow-sm mt-5 ">
      <figure>
      ...
      <div className="flex justify-around w-full gap-3 mt-14">
        ...
        <div className="card-actions justify-center">
          <div className="join join-vertical">
            <Link to={`/coffee/${_id}`}>
              <button className="btn rounded bg-orange-300 mb-2">
                <FaEye size={20} />
              </button>
            </Link>

            <Link to={`/updateCoffee/${_id}`}>
              <button className="btn rounded mb-2">
                <FaPen size={20} />
              </button>
            </Link>
            ...
            <button
              ...
              className="btn rounded bg-red-500"
            >
              <MdDelete size={20} />
            </button>
          </div>
